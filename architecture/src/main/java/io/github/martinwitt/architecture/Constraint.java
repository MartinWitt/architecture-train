...
import io.github.martinwitt.architecture.errorhandling.IError;
...
public class Constraint<T> implements IConstraint<T> {
    ...
    public static <T extends CtElement> Constraint<T> of(IError<T> errorHandler, Predicate<T>... conditions) {
    ...
    public static <T extends CtElement> Constraint<T> of(IError<T> errorHandler, Predicate<T> condition) {
